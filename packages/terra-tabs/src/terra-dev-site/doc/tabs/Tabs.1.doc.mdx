...
import TabPropsTable from 'terra-tabs/src/Tab?dev-site-props-table';
import TabsPropsTable from 'terra-tabs/src/Tabs?dev-site-props-table';
import TabBarPropsTable from 'terra-tabs/src/TabBar?dev-site-props-table';

import TabsTemplate from '../../../pages/TempImplement';
